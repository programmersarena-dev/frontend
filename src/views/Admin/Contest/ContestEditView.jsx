...
export default function ContestEditView() {
  ...
  // Same hours/minutes split as AddContest. The API validates `duration`
  // as an "H:i" string (StoreContestRequest: required|date_format:H:i),
  // so that's the field name and format actually sent on save.
